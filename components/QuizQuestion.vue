...
const props = defineProps({
    ...
    // 选项数组，每个选项是一个对象，包含 label 和 text
    options: {
        type: Array,
        required: true
    },
...
function submitAnswer() {
    if (selectedOption.value !== null && !isSubmitted.value) {
        ...
        isCorrect.value = selectedOption.value === props.correctIndex;
    }
}
    ...
    <div class="quiz-container" :class="{ 'dark': isDark }">
        ...
        <div class="options">
            <div v-for="(option, index) in options" :key="index" class="option" :class="{
                ...
                'correct': isSubmitted && index === correctIndex,
                'incorrect': isSubmitted && selectedOption === index && index !== correctIndex
        ...
        <div class="controls">
            <button class="submit-btn" @click="submitAnswer" :disabled="selectedOption === null || isSubmitted">
                提交答案
            </button>
